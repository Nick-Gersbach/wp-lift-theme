...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#navbarResponsive">
    ...
    <div id="home">
      ...
      <div class="landing">
        <div class="home-wrap">
          <div class="home-inner" style="  background: linear-gradient(rgba(20, 20, 20, 0.7), rgba(20, 20, 20, 0.7)),
    url(<?php echo get_template_directory_uri().'/images/showcase.jpg'; ?>) no-repeat center center/cover;
  position: fixed;
  height: 100%;
  width: 100%;
  ...
  display: table;"></div>
      ...
      <div class="caption text-center text-light text-uppercase">
        <h1
          ...
          data-delay=".6s"
        >
          Welcome to <span class="text-nuno">Lift Theme</span>
        </h1>
        <h3
          class="os-animation"
          data-animation="animate__animated animate__fadeInUp"
          data-delay=".8s"
        >
          Build Muscle - Burn Fat - Get Healthy
        </h3>
        <a
          href="#features"
