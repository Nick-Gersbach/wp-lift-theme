...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#navbarResponsive">
    ...
    <div id="home">
      ...
      <div class="landing">
        <div class="home-wrap">
          <div class="home-inner" style="background: linear-gradient(rgba(20, 20, 20, 0.8), rgba(20, 20, 20, 0.8)),
    url(<?php echo get_template_directory_uri().'/images/blog-header-showcase.jpg'; ?>) no-repeat center center/cover;
  position: fixed;
  height: 100%;
  width: 100%;
  ...
  display: table;"></div>
      ...
      <div class="caption text-center text-light text-uppercase">
        ...
        <p
          ...
          data-delay=".8s"
        >
          Stay up to date with the latest fitness tips
        </p>
